...
// Clear / X Circle Icon (for search clear)
export function ClearIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <circle cx="12" cy="12" r="10" />
...
export function AlertCircleIcon({ className = 'w-16 h-16' }: IconProps) {
  return (
...
// Empty / No Data Icon (same as Logo)
export function EmptyIcon({ className = 'w-16 h-16' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 2L2 7l10 5 10-5-10-5z" />
      <path d="M2 17l10 5 10-5" />
...
// 404 / Not Found Icon
export function NotFoundIcon({ className = 'w-24 h-24' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <circle cx="12" cy="12" r="10" />
...
export function BookmarkFilledIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
